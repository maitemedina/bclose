...
class UIBpm extends StatelessWidget {
  ...
  init(BuildContext context){
    ...
    permission.listen((event) {
      if(event)
        deviceController.startScan("BPM_01");
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                                flex:1 ,
                                child: UILabels.Regular(text: "Pressao arterial", textLines: 1,fontSize: 16,textAlign: TextAlign.left,)
                            ),
                            // ignore: unnecessary_null_comparison
                            UILabels.Regular(text: deviceController.BPM_READING.length > 0  ? Util.parseDataH( deviceController.BPM_READING[0].timestamp.toString()) :"0", textLines: 1,fontSize: 16,)
                          ],
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Stack(
                        children: [
                          Image.asset(
                            'packages/bclose/assets/device/ic_grafico_pressao_arterial.png',
                          ...
                          Container(
                            alignment: Alignment.topRight,
                              child: Column(
                                children: [
                                  UILabels.Bold(text: "${deviceController.BPM_READING.length > 0 ? deviceController.BPM_READING[0].pulseRate : "0"}", textLines: 1,fontSize: 30,color: AppColors.Black,),
                                  UILabels.Regular(text: "Bpm", textLines: 1,fontSize: 14,color: AppColors.Black,)
                                ],
                              ))
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            UILabels.Bold(text: "${deviceController.BPM_READING.length > 0 ? deviceController.BPM_READING[0].diastolic : "0"}", textLines: 1,fontSize: 24,color: AppColors.Black,),
                            UILabels.Regular(text: "DYS", textLines: 1,fontSize: 12,color: AppColors.Blue,)
                          ],
                        ),
                        SizedBox(width: 16,),
                        Row(
                          children: [
                            UILabels.Bold(text: "${deviceController.BPM_READING.length > 0 ? deviceController.BPM_READING[0].systolic : "0"}", textLines: 1,fontSize: 24,color: AppColors.Black,),
                            UILabels.Regular(text: "SYS", textLines: 1,fontSize: 12,color: AppColors.Blue,)
                          ],
                        ),
                        SizedBox(width: 16,),
                        Padding(
